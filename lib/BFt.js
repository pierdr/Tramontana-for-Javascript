...
window.BFtObject= function () {
        ...
        object.callbacks 				= {videoended:0,socketopen:0,distance:0,orientation:0,attitude:0,magnetometer:0,touch:0,audiojack:0,powersource:0,rxembedded:0};
			...
			try {
				...
				object.socket.onmessage =function got_packet(msg) {
					...
					if(messageObject["m"]=="touched")
					{
				        ...
				        {
				        	object.callbacks.touched('touched', {"address":ipAddress,"x":messageObject["x"],"y":messageObject["y"]});
				        }
						else
						{
								object.touched = true;
					...
					else if(messageObject["m"] == "a")
					{
				        ...
				        {
				        	object.callbacks.attitude('receivedRx', {"address":ipAddress,"v":messageObject["v"]});
				        }
					}
					...
					else if(messageObject["m"] == "rx")
					{
				        ...
				        {
				        	object.callbacks.rxembedded('receivedRx', {"address":ipAddress,"v":messageObject["v"]});
				        }
					}
					...
					}else if(messageObject["m"] == "videoEnded")
					{
				        ...
				        {
				        	object.callbacks.videoended('videoEnded', {"address":ipAddress});
				        }
						try{
					        videoEnded();
						}
