			...
			try {
				...
				object.socket.onmessage =function got_packet(msg) {
					...
					else if(messageObject["m"] == "orientationChanged")
					{
						...
						if(object.callbacks.orientation!=undefined)
				        {
					...
					else if(messageObject["m"] == "distanceChanged")
					{
						...
						try{
					        ...
					        if(object.callbacks.distance!=undefined)
					        {
					...
					else if(messageObject["m"] == "audioJackChanged")
					{
						...
						if(object.callbacks.audiojack!=undefined)
				        {
				        	object.callbacks.audiojack();
				        }
						try{
					...
					else if(messageObject["m"] == "powerSourceChanged")
					{
						...
						if(object.callbacks.powersource!=undefined)
				        {
					...
					{
						if(object.callbacks.videoended!=undefined)
				        {
				        	object.callbacks.videoended();
				        }
						try{
					        videoEnded();
						}
